...
/**
     ...
     */function l(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);return t}function h(t,e){var i=e?"":"none";l(t.style,{touchAction:e?"":"none",webkitUserDrag:e?"":"none",webkitTapHighlightColor:e?"":"transparent",userSelect:i,msUserSelect:i,webkitUserSelect:i,MozUserSelect:i})}function p(t,e){var i=t.style;i.position=e?"":"fixed",i.top=i.opacity=e?"":"0",i.left=e?"":"-999em"}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function g(t){var e=t.getBoundingClientRect();return{top:e.top,right:e.right,bottom:e.bottom,left:e.left,width:e.width,height:e.height}}function _(t,e,i){return i>=t.top&&i<=t.bottom&&e>=t.left&&e<=t.right}function f(t,e,i){t.top+=e,t.bottom=t.top+t.height,t.left+=i,t.right=t.left+t.width}function m(t,e,i,r){var n=t.width*e,o=t.height*e;return r>t.top-o&&r<t.bottom+o&&i>t.left-n&&i<t.right+n}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var v=function(){function t(t,e){this._document=t,this._viewportRuler=e,this.positions=new Map}return t.prototype.clear=function(){this.positions.clear()},t.prototype.cache=function(t){var e=this;this.clear(),this.positions.set(this._document,{scrollPosition:this._viewportRuler.getViewportScrollPosition()}),t.forEach((function(t){e.positions.set(t,{scrollPosition:{top:t.scrollTop,left:t.scrollLeft},clientRect:g(t)})}))},t.prototype.handleScroll=function(t){var e=t.target,i=this.positions.get(e);if(!i)return null;var r,n,o=e===this._document?e.documentElement:e,s=i.scrollPosition;if(e===this._document){var a=this._viewportRuler.getViewportScrollPosition();r=a.top,n=a.left}else r=e.scrollTop,n=e.scrollLeft;var c=s.top-r,l=s.left-n;return this.positions.forEach((function(t,i){t.clientRect&&e!==i&&o.contains(i)&&f(t.clientRect,c,l)})),s.top=r,s.left=n,{top:c,left:l}},t}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function y(t){var e=t.cloneNode(!0),i=e.querySelectorAll("[id]"),r=t.nodeName.toLowerCase();e.removeAttribute("id");for(var n=0;n<i.length;n++)i[n].removeAttribute("id");return"canvas"===r?P(t,e):"input"!==r&&"select"!==r&&"textarea"!==r||S(t,e),b("canvas",t,e,P),b("input, textarea, select",t,e,S),e}function b(t,e,i,r){var n=e.querySelectorAll(t);if(n.length)for(var o=i.querySelectorAll(t),s=0;s<n.length;s++)r(n[s],o[s])}var D=0;function S(t,e){"file"!==e.type&&(e.value=t.value),"radio"===e.type&&e.name&&(e.name="mat-clone-"+e.name+"-"+D++)}function P(t,e){var i=e.getContext("2d");if(i)try{i.drawImage(t,0,0)}catch(t){}}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(a,s.clientRect,t,e),2),o=c[1],((n=c[0])||o)&&(r=a))})),!n&&!o){var s=this._viewportRuler.getViewportSize(),a=s.width,c=s.height,l={width:a,height:c,top:0,right:a,bottom:c,left:0};n=V(l,e),o=B(l,t),r=window}!r||n===this._verticalScrollDirection&&o===this._horizontalScrollDirection&&r===this._scrollNode||(this._verticalScrollDirection=n,this._horizontalScrollDirection=o,this._scrollNode=r,(n||o)&&r?this._ngZone.runOutsideAngular(this._startScrollInterval):this._stopScrolling())}},t.prototype._stopScrolling=function(){this._stopScrollTimers.next()},t.prototype._draggingStarted=function(){var t=o.coerceElement(this.element).style;this.beforeStarted.next(),this._isDragging=!0,this._initialScrollSnap=t.msScrollSnapType||t.scrollSnapType||"",t.scrollSnapType=t.msScrollSnapType="none",this._cacheItems(),this._viewportScrollSubscription.unsubscribe(),this._listenToScrollEvents()},t.prototype._cacheParentPositions=function(){var t=o.coerceElement(this.element);this._parentPositions.cache(this._scrollableElements),this._clientRect=this._parentPositions.positions.get(t).clientRect},t.prototype._cacheItemPositions=function(){var t="horizontal"===this._orientation;this._itemPositions=this._activeDraggables.map((function(t){var e=t.getVisibleElement();return{drag:t,offset:0,clientRect:g(e)}})).sort((function(e,i){return t?e.clientRect.left-i.clientRect.left:e.clientRect.top-i.clientRect.top}))},t.prototype._reset=function(){var t=this;this._isDragging=!1;var e=o.coerceElement(this.element).style;e.scrollSnapType=e.msScrollSnapType=this._initialScrollSnap,this._activeDraggables.forEach((function(t){var e=t.getRootElement();e&&(e.style.transform="")})),this._siblings.forEach((function(e){return e._stopReceiving(t)})),this._activeDraggables=[],this._itemPositions=[],this._previousSwap.drag=null,this._previousSwap.delta=0,this._previousSwap.overlaps=!1,this._stopScrolling(),this._viewportScrollSubscription.unsubscribe(),this._parentPositions.clear()},t.prototype._getSiblingOffsetPx=function(t,e,i){var r="horizontal"===this._orientation,n=e[t].clientRect,o=e[t+-1*i],s=n[r?"width":"height"]*i;if(o){var a=r?"left":"top",c=r?"right":"bottom";-1===i?s-=o.clientRect[a]-n[c]:s+=n[a]-o.clientRect[c]}return s},t.prototype._getItemOffsetPx=function(t,e,i){var r="horizontal"===this._orientation,n=r?e.left-t.left:e.top-t.top;return-1===i&&(n+=r?e.width-t.width:e.height-t.height),n},t.prototype._shouldEnterAsFirstChild=function(t,e){if(!this._activeDraggables.length)return!1;var i=this._itemPositions,r="horizontal"===this._orientation;if(i[0].drag!==this._activeDraggables[0]){var n=i[i.length-1].clientRect;return r?t>=n.right:e>=n.bottom}var o=i[0].clientRect;return r?t<=o.left:e<=o.top},t.prototype._getItemIndexFromPointerPosition=function(t,e,i,r){var n=this,o="horizontal"===this._orientation,s=z(this._itemPositions,(function(s,a,c){var l=s.drag,h=s.clientRect;return l===t?c.length<2:(!r||l!==n._previousSwap.drag||!n._previousSwap.overlaps||(o?r.x:r.y)!==n._previousSwap.delta)&&(o?e>=Math.floor(h.left)&&e<Math.floor(h.right):i>=Math.floor(h.top)&&i<Math.floor(h.bottom))}));return-1!==s&&this.sortPredicate(s,t,this)?s:-1},t.prototype._cacheItems=function(){this._activeDraggables=this._draggables.slice(),this._cacheItemPositions(),this._cacheParentPositions()},t.prototype._isOverContainer=function(t,e){return null!=this._clientRect&&_(this._clientRect,t,e)},t.prototype._getSiblingContainerFromPosition=function(t,e,i){return this._siblings.find((function(r){return r._canReceive(t,e,i)}))},t.prototype._canReceive=function(t,e,i){if(!this._clientRect||!_(this._clientRect,e,i)||!this.enterPredicate(t,this))return!1;var r=this._getShadowRoot().elementFromPoint(e,i);if(!r)return!1;var n=o.coerceElement(this.element);return r===n||n.contains(r)},t.prototype._startReceiving=function(t,e){var i=this,r=this._activeSiblings;!r.has(t)&&e.every((function(t){return i.enterPredicate(t,i)||i._draggables.indexOf(t)>-1}))&&(r.add(t),this._cacheParentPositions(),this._listenToScrollEvents())},t.prototype._stopReceiving=function(t){this._activeSiblings.delete(t),this._viewportScrollSubscription.unsubscribe()},t.prototype._listenToScrollEvents=function(){var t=this;this._viewportScrollSubscription=this._dragDropRegistry.scroll.subscribe((function(e){if(t.isDragging()){var i=t._parentPositions.handleScroll(e);i&&(t._itemPositions.forEach((function(t){f(t.clientRect,i.top,i.left)})),t._itemPositions.forEach((function(e){var i=e.drag;t._dragDropRegistry.isDragging(i)&&i._sortFromLastPointerPosition()})))}else t.isReceiving()&&t._cacheParentPositions()}))},t.prototype._getShadowRoot=function(){if(!this._cachedShadowRoot){var t=n._getShadowRoot(o.coerceElement(this.element));this._cachedShadowRoot=t||this._document}return this._cachedShadowRoot},t.prototype._notifyReceivingSiblings=function(){var t=this,e=this._activeDraggables.filter((function(t){return t.isDragging()}));this._siblings.forEach((function(i){return i._startReceiving(t,e)}))},t}();function z(t,e){for(var i=0;i<t.length;i++)if(e(t[i],i,t))return i;return-1}function H(t,e){t===window?t.scrollBy(0,e):t.scrollTop+=e}function F(t,e){t===window?t.scrollBy(e,0):t.scrollLeft+=e}function V(t,e){var i=t.top,r=t.bottom,n=.05*t.height;return e>=i-n&&e<=i+n?1:e>=r-n&&e<=r+n?2:0}function B(t,e){var i=t.left,r=t.right,n=.05*t.width;return e>=i-n&&e<=i+n?1:e>=r-n&&e<=r+n?2:0}var G=n.normalizePassiveListenerOptions({passive:!1,capture:!0}),U=function(){function t(t,e){var i=this;this._ngZone=t,this._dropInstances=new Set,this._dragInstances=new Set,this._activeDragInstances=[],this._globalListeners=new Map,this._draggingPredicate=function(t){return t.isDragging()},this.pointerMove=new s.Subject,this.pointerUp=new s.Subject,this.scroll=new s.Subject,this._preventDefaultWhileDragging=function(t){i._activeDragInstances.length>0&&t.preventDefault()},this._persistentTouchmoveListener=function(t){i._activeDragInstances.length>0&&(i._activeDragInstances.some(i._draggingPredicate)&&t.preventDefault(),i.pointerMove.next(t))},this._document=e}return t.prototype.registerDropContainer=function(t){this._dropInstances.has(t)||this._dropInstances.add(t)},t.prototype.registerDragItem=function(t){var e=this;this._dragInstances.add(t),1===this._dragInstances.size&&this._ngZone.runOutsideAngular((function(){e._document.addEventListener("touchmove",e._persistentTouchmoveListener,G)}))},t.prototype.removeDropContainer=function(t){this._dropInstances.delete(t)},t.prototype.removeDragItem=function(t){this._dragInstances.delete(t),this.stopDragging(t),0===this._dragInstances.size&&this._document.removeEventListener("touchmove",this._persistentTouchmoveListener,G)},t.prototype.startDragging=function(t,e){var i=this;if(!(this._activeDragInstances.indexOf(t)>-1)&&(this._activeDragInstances.push(t),1===this._activeDragInstances.length)){var r=e.type.startsWith("touch");this._globalListeners.set(r?"touchend":"mouseup",{handler:function(t){return i.pointerUp.next(t)},options:!0}).set("scroll",{handler:function(t){return i.scroll.next(t)},options:!0}).set("selectstart",{handler:this._preventDefaultWhileDragging,options:G}),r||this._globalListeners.set("mousemove",{handler:function(t){return i.pointerMove.next(t)},options:G}),this._ngZone.runOutsideAngular((function(){i._globalListeners.forEach((function(t,e){i._document.addEventListener(e,t.handler,t.options)}))}))}},t.prototype.stopDragging=function(t){var e=this._activeDragInstances.indexOf(t);e>-1&&(this._activeDragInstances.splice(e,1),0===this._activeDragInstances.length&&this._clearGlobalListeners())},t.prototype.isDragging=function(t){return this._activeDragInstances.indexOf(t)>-1},t.prototype.ngOnDestroy=function(){var t=this;this._dragInstances.forEach((function(e){return t.removeDragItem(e)})),this._dropInstances.forEach((function(e){return t.removeDropContainer(e)})),this._clearGlobalListeners(),this.pointerMove.complete(),this.pointerUp.complete()},t.prototype._clearGlobalListeners=function(){var t=this;this._globalListeners.forEach((function(e,i){t._document.removeEventListener(i,e.handler,e.options)})),this._globalListeners.clear()},t}();U.ɵprov=e.ɵɵdefineInjectable({factory:function t(){return new U(e.ɵɵinject(e.NgZone),e.ɵɵinject(i.DOCUMENT))},token:U,providedIn:"root"}),U.decorators=[{type:e.Injectable,args:[{providedIn:"root"}]}],U.ctorParameters=function(){return[{type:e.NgZone},{type:void 0,decorators:[{type:e.Inject,args:[i.DOCUMENT]}]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Z={dragStartThreshold:5,pointerDirectionChangeThreshold:5},q=function(){function t(t,e,i,r){this._document=t,this._ngZone=e,this._viewportRuler=i,this._dragDropRegistry=r}return t.prototype.createDrag=function(t,e){return void 0===e&&(e=Z),new R(t,e,this._document,this._ngZone,this._viewportRuler,this._dragDropRegistry)},t.prototype.createDropList=function(t){return new N(t,this._dragDropRegistry,this._document,this._ngZone,this._viewportRuler)},t}();q.ɵprov=e.ɵɵdefineInjectable({factory:function t(){return new q(e.ɵɵinject(i.DOCUMENT),e.ɵɵinject(e.NgZone),e.ɵɵinject(r.ViewportRuler),e.ɵɵinject(U))},token:q,providedIn:"root"}),q.decorators=[{type:e.Injectable,args:[{providedIn:"root"}]}],q.ctorParameters=function(){return[{type:void 0,decorators:[{type:e.Inject,args:[i.DOCUMENT]}]},{type:e.NgZone},{type:r.ViewportRuler},{type:U}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */Y.decorators=[{type:e.Directive,args:[{selector:"[cdkDropListGroup]",exportAs:"cdkDropListGroup",providers:[{provide:K,useExisting:Y}]}]}],Y.propDecorators={disabled:[{type:e.Input,args:["cdkDropListGroupDisabled"]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var tt=new e.InjectionToken("CdkDragHandle"),et=function(){function t(t,e){this.element=t,this._stateChanges=new s.Subject,this._disabled=!1,this._parentDrag=e}return Object.defineProperty(t.prototype,"disabled",{get:function(){return this._disabled},set:function(t){this._disabled=o.coerceBooleanProperty(t),this._stateChanges.next(this)},enumerable:!1,configurable:!0}),t.prototype.ngOnDestroy=function(){this._stateChanges.complete()},t}();et.decorators=[{type:e.Directive,args:[{selector:"[cdkDragHandle]",host:{class:"cdk-drag-handle"},providers:[{provide:tt,useExisting:et}]}]}],et.ctorParameters=function(){return[{type:e.ElementRef},{type:void 0,decorators:[{type:e.Inject,args:[W]},{type:e.Optional},{type:e.SkipSelf}]}]},et.propDecorators={disabled:[{type:e.Input,args:["cdkDragHandleDisabled"]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var it,rt=new e.InjectionToken("CdkDragPlaceholder");(it=function it(t){this.templateRef=t}).decorators=[{type:e.Directive,args:[{selector:"ng-template[cdkDragPlaceholder]",providers:[{provide:rt,useExisting:it}]}]}],it.ctorParameters=function(){return[{type:e.TemplateRef}]},it.propDecorators={data:[{type:e.Input}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.CDK_DRAG_CONFIG=X,t.CDK_DRAG_HANDLE=tt,t.CDK_DRAG_PARENT=W,t.CDK_DRAG_PLACEHOLDER=rt,t.CDK_DRAG_PREVIEW=nt,t.CDK_DROP_LIST=Q,t.CDK_DROP_LIST_GROUP=K,t.CdkDrag=at,t.CdkDragHandle=et,t.CdkDragPlaceholder=it,t.CdkDragPreview=ot,t.CdkDropList=$,t.CdkDropListGroup=Y,t.DragDrop=q,t.DragDropModule=st,t.DragDropRegistry=U,t.DragRef=R,t.DropListRef=N,t.copyArrayItem=function lt(t,e,i,r){var n=M(r,e.length);t.length&&e.splice(n,0,t[i])},t.moveItemInArray=j,t.transferArrayItem=function ht(t,e,i,r){var n=M(i,t.length-1),o=M(r,e.length);t.length&&e.splice(o,0,t.splice(n,1)[0])},Object.defineProperty(t,"__esModule",{value:!0})}));